...
?>
  ...
  <head>
    ...
    <title>SDN 012 BALIKPAPAN KOTA | Dasbor</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><b>SDN 012 BALIKPAPAN KOTA</b>P</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b></b>PERPUSTAKAAN</span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>SDN 012 BALIKPAPAN KOTA</a></strong>
      </footer>Repost
